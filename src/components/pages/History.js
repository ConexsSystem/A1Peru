...
import { formatearFecha, formatDateTime, truncateText } from '../../utils/utils';
  ...
  return (
    <div className='page'>
      ...
      <Topbar
        ...
        exportFileName="Historial.xlsx"    // Nombre del archivo
        exportSheetName="Historial"        // Nombre de la hoja
      />
